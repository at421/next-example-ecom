...
import useOnClickOutside from "use-onclickoutside"; // Assuming this hook is correctly located

import type { RootState } from "@/store";

import Logo from "@/assets/icons/logo"; // Updated import path
...
const Header = ({ isErrorPage }: HeaderType) => {
  ...
  useEffect(() => {
    ...
    return () => {
        window.onscroll = null; // Cleanup the event listener
    };
