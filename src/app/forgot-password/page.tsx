      ...
      <div className="container">
        ...
        <div className="form-block">
          ...
          <form className="form" onSubmit={handleSubmit(onSubmit)}>
            ...
            {/* The original code had a password field here, which seems incorrect for a "Forgot Password" form requesting email. Assuming it was a copy-paste error and removing the password field input and validation */}
            {/* <div className="form__input-row">
              <input
                className="form__input"
                type="password"
